// * Exercise: Create a function called "filterArray" to filter only positive number(จำนวนเต็ม+)
// * 1. This function receive 2 parameters, arr and cb.
// * 2. cb function must receive 1 parameter, which is each item from the array
// * 3. cb must return only boolean, if it return true, keep that item, otherwise, don't keep it.(เก็บค่าที่เป็นTrue ทั่วนั้น)
